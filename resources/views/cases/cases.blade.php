          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">List of Cases</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Handled By</th>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{$c->aname}}</h6>
                              <p class="text-xs text-secondary mb-0">{{$c->created_by}}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0">{{$c->uname}}</p>
                          <p class="text-xs text-secondary mb-0">{{$c->updated_by}}</p>
                        </td>
                        <td class="align-middle text-center text-sm">
                          
                                      @if($c->status == 0)
                                      <span class="badge badge-sm bg-gradient-danger">Reported</span>
                                      @elseif($c->status == 1)
                        ...
                        <td class="align-middle text-center">
                          <a href="{{route('case.info', ['id' => $c->id])}}" title="Check Case" class="text-secondary font-weight-bold text-xs">More Info</a>
                        </td>
                      </tr>
                    </tbody>
                    @endforeach
