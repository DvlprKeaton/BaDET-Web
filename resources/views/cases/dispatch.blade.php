          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Dispatch Emergency Team</h6>
              </div>
            </div>
            <form class="form-horizontal" action="{{route('submitDispatch')}}" method="POST">
              @csrf
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <div class="span7" style="padding-left: 50px; margin-bottom: 20px;">
                  <div class="control-group ">
                      <label class="control-label">Emergency Team<span class="required">*</span></label>
                      <div class="controls">
                  ...
                  <div style="padding-left: 50px">
                    <div class="span7">
                      <input type="hidden" name="case_id" value="{{$id}}">
                        <button id="submit-button" type="submit" class="btn btn-info" name="submit-button" value="Confirm">Dispatch</button>
                        <a type="button"  class="btn btn-danger" name="action" href="{{ url()->previous() }}" >Cancel</a>
                    </div>
                  </div>
              </form>
              </div>
