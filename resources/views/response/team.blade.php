...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div>
      <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="{{route('addTeam')}}">Add Team</a>
      <hr>
      @if(count($holdteam))
      <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="{{route('myTeam', ['id' => $tid])}}">My Team</a>
      @endif
      <hr>
      </div>
      <div class="row">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Response Team</h6>
              </div>
            </div>
                    ...
                    @if(count($data))
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$d->team_name}}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$d->address}}</p>
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="{{route('response.edit', ['id' => $d->id])}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                    </tr>
