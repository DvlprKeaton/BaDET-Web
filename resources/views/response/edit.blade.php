      ...
      <div class="row">
        <div class="col-12">
          <div class="card my-4">
            ...
            <form class="form-horizontal" action="{{route('updateTeam')}}" method="POST">
              @csrf
              ...
              <div class="table-responsive p-0">
                <div class="span7" style="padding-left: 50px; margin-bottom: 20px;">
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        @foreach($info as $i)
                          <input id="tname" name="tname" class="span5"  placeholder="Enter team name..." type="text"  value="{{$i->team_name}}">
                        @endforeach
                      </div>
                  </div>
                </div>
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            ...
                            <select name="user_handler" id="user_handler">
                              ...
                              @endforeach
                              @foreach($uHand as $uh)
                              <option value="{{$uh->id}}">{{$uh->name}}</option>
                              @endforeach
                            </select>
                      </div>
                  </div>
                ...
                <div class="span7" style="padding-left: 50px; margin-bottom: 20px;">
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        @foreach($info as $i)
                          <input id="taddress" name="taddress" class="span5"  placeholder="Enter address..." type="text"  value="{{$i->address}}">
                        @endforeach
                      </div>
                  </div>
                </div>
                <div class="span7" style="padding-left: 50px; margin-bottom: 20px;">
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        ...
                        @foreach($info as $i)
                          <input id="tcontact" name="tcontact" class="span5"  placeholder="Enter contact number..." type="number"  value="{{$i->contact_number}}">
                        @endforeach
                      </div>
                  </div>
                </div>
